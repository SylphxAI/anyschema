import type { SchemaVendor, DetectionResult } from './types.js';
...
export function detect(schema: unknown): DetectionResult | null {
  ...
  if (typeof schema === 'function') {
    ...
    if ('toJsonSchema' in schema && typeof (schema as Record<string, unknown>)['toJsonSchema'] === 'function') {
  ...
  if ('_def' in schema && 'parse' in schema && typeof (schema as Record<string, unknown>)['parse'] === 'function') {
  ...
  if ('__isYupSchema__' in schema && (schema as Record<string, unknown>)['__isYupSchema__'] === true) {
